                ...
                <PrositStyled className="card-body">
                    ...
                    </ul>
                    {
                        (prosit.aller) ? (
                            ...
                            <FormulaireFichier prositType="aller"> </FormulaireFichier>
                        )
                    }
                    {
                        (prosit.retour) ? (
                            ...
                            <FormulaireFichier prositType="retour" > </FormulaireFichier>
                        )
                    }
                </PrositStyled>
            </div>
